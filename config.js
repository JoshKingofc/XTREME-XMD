...
MENU_IMAGE_URL: process.env.MENU_IMAGE_URL || "https://files.catbox.moe/dnjqau.jpg",
...
PREFIX: process.env.PREFIX || ".",
    ...
    TIME_ZONE: process.env.TIME_ZONE || "Africa/Bulawayo",  // Change to your preferred timezone
// add your prifix for bot   
BOT_NAME: process.env.BOT_NAME || "𝔑3𝔱𝔎𝔦𝔫𝔤 𝐗𝐌𝐃",
// add bot namw here for menu
STICKER_NAME: process.env.STICKER_NAME || "•᭄͢❈🏴‍☠️𝐏𝐑𝐎𝐅𝐄𝐒𝐒𝐎𝐑 𝔑3𝔱𝔎𝔦𝔫𝔤🇿🇼",
...
OWNER_NAME: process.env.OWNER_NAME || "‎✦『ᴶᴼˢᴴᵁᴬᴹᴬᴹᴮᴼ1』✦",
// add bot owner name
